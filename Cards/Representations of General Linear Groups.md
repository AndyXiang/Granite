...
2. hook-content formula $$\prod_{i,j} \frac{n+c_{ij}}{h_{ij}}$$ where $h_{ij}$ is the number of boxes on the right of and below $i,j$-th box plus $1$, called *hook-length*, and $c_{ij}=j-i$ called content.