...
$$K(x,y)=\mathrm{tr}(\mathfrak{ad}(x)\circ\mathfrak{ad}(y)),x,y\in \mathfrak{g}$$
...
$$K(x_{i},x_{j})=\sum_{k,l}C_{ik}^{~~~~l}C_{jl}^{~~~k}.$$


## Properties
1. Killing form is *invariant*: $K(x,[y,z])=K([x,y],z)$.
2. $\mathfrak{g}$ is [[Solvable Lie Algebra|solvable]] iff $K(x,y)=0$ for every $x\in[\mathfrak{g},\mathfrak{g}]$ and $y\in \mathfrak{g}$.
3. $\mathfrak{g}$ is [[Simple Lie Algebra|semisimple]] iff $K(x,y)$ is non-degenerate.
