...
---
**Tangent bundle** is a [[Vector Bundle|vector bundle]] $(E,M,TM,\pi)$ where $E$ and $M$ are [[Differential Manifold|differential manifold]], and $TM$ is the [[Tangent Space|tangent space]] of $M$. Here $\pi$ and local trivializations are [[Smooth Mapping|smooth mappings]]. 
