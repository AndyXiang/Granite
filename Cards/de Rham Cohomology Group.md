...
## de Rham Theorem
As the name suggests, the cohomology group $H^{r}(M)$ is the [[Dual Space|dual space]] of the [[Homology Group|homology group]] $H_{r}(M)$. First one has a bilinear [[Map|map]]
$$(,): \begin{matrix}
