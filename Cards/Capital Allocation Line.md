...
$$\mathbb{E}(r_{C})=r_{F}+\sigma_{C} \frac{\mathbb{E}(r_{P})-r_{F}}{\sigma_{P}},$$
...
$$\mathbb{E}(r_{C})=\left\{ \begin{align}
&r_{F}+\sigma_{C} \frac{\mathbb{E}(r_{P})-r_{F}}{\sigma_{P}} &\sigma_{C}\geq\sigma_{P}  \\
&r_{B}+\sigma_{C} \frac{\mathbb{E}(r_{P})-r_{B}}{\sigma_{P}} &\sigma_{C}<\sigma_{P}
\end{align} \right. $$
