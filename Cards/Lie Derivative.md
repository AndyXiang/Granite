...
---
Given a [[Differential Manifold|smooth manifold]] $M$ and a [[Tangent Bundle|smooth vector field]] $X\in \mathfrak{X}(M)$, the **Lie derivative** $\mathcal{L}_{X}$ is a series of operators on the spaces of [[Exterior Differential Form|differential forms]], of [[Function|functions]], and other [[Tensor Field (Manifold)|tensor fields]]. 
